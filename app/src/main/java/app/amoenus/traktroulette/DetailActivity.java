...
public class DetailActivity extends ActionBarActivity {
    ...
    public static class DetailFragment extends Fragment {
        ...
        private  static final String FORECAST_SHARE_HASHTAG = " #Trakt Roulette";
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            ...
            //Get the provider and hold onto it ti set/change the share intent.
            ShareActionProvider mShareActionProvider = (ShareActionProvider) MenuItemCompat.getActionProvider(menuItem);

            //Attach an intent to this ShareActionAdapter. You can update this anytime,
